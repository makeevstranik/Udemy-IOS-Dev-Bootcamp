...
struct StoryBrain {
    ...
    var getTitle: String { story[storyPosition].title }
    var getChoice1: String { story[storyPosition].choice1 }
    var getChoice2: String { story[storyPosition].choice2 }
    
    mutating func updateStory(choice: ButtonChoice) {
        switch choice.rawValue {
            case 1: storyPosition = story[storyPosition].choice1Destination
            case 2: storyPosition = story[storyPosition].choice2Destination
            default: storyPosition = 0
        }
    }
